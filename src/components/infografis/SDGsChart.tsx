              ...
              <div className="mb-3">
                ...
                <div className="flex space-x-2">
                  {initiative.sdg.map((sdgId) => (
                    <span
                      key={sdgId}
                      className="w-6 h-6 bg-emerald-500 text-white rounded-full flex items-center justify-center text-xs font-bold"
                    >
                      {sdgId}
                    </span>
                  ))}
        ...
        <div className="flex items-center">
          <div className="flex-1">
            <div className="bg-gray-200 rounded-full h-6">
              <div
                className="bg-gradient-to-r from-emerald-400 to-blue-500 h-6 rounded-full transition-all duration-500 flex items-center justify-end pr-2"
                style={{
                  width: `${
