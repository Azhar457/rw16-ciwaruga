  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-r from-emerald-700 to-emerald-400 rounded-lg p-6">
        ...
        <div className=" bg-gradient-to-r from-purple-700 to-pink-200 rounded-lg p-6">
          <div className="flex items-center">
            <div className="text-3xl mr-4">👨</div>
            <div>
        ...
        <div className="bg-gradient-to-r from-pink-500 to-blue-400 rounded-lg p-6 text-white">
          <div className="flex items-center">
            <div className="text-3xl mr-4">👩</div>
            <div>
